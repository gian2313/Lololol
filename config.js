...
const CONFIG = {
    ...
    questions: {
        first: {
            text: "Let's hangout sometime we're free",                                    // First interaction
            yesBtn: "Coolcool",                                             // Text for "Yes" button
            noBtn: "No am gonna be buzy lockin twin",                                               // Text for "No" button
    ...
    loveMessages: {
        extreme: "DAMNNN nyahahahahhahah",  // Shows when they go past 5000%
        high: "UYYYYYY",              // Shows when they go past 1000%
        normal: "uy"                           // Shows when they go past 100%
    },
